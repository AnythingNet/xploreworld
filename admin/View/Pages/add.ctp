...
<?php echo $this->Form->create('Page', array('type' => 'post', 'url' => 'add')); ?>
  ...
  <div class="section-left row">
    ...
    <div class="form-group col-lg-12">
      ...
      <?php echo $this->Form->input('meta_description', array('type' => 'text', 'class' => 'page-inputs form-control', 'placeholder' => 'Add page meta description')); ?>
    </div>
    ...
    <div id="content-input-area" class="col-lg-12">
      ...
      <?php echo $this->Form->textarea('content', array('id' => 'editor')); ?>
