...
/* Custom: filepath  */
Configure::write('File.path', dirname(APP) . DS . 'app' . DS . 'webroot' . DS . 'uploads' . DS);
...
Configure::write('Theme.location', dirname(APP) . DS . 'app' . DS . 'View' . DS . 'Themed' . DS);

/* specify a path for user config */
App::build(array('AppConfig' => array(dirname(APP) . DS . 'app' . DS . 'Config' . DS)), App::REGISTER);
